...
def run_p5_offline_pilot() -> dict[str, Any]:
    ...
    def context_coverage() -> tuple[bool, str, dict[str, Any]]:
        ...
        passed = (
            coverage["total_entities"] == 49
            and coverage["context_covered_entities"] == 49
            and coverage["context_coverage_percent"] == 100.0
            and coverage["context_gaps"] == []
        )
        return passed, "all 49 canonical entities have bounded offline context", coverage
    ...
    def operational_coverage() -> tuple[bool, str, dict[str, Any]]:
        coverage = registry.coverage_report(entities)
        passed = (
            coverage["operationally_covered_entities"] == 49
        ...
        return passed, "all 49 entities have owner-reviewed procedures; live state remains unverified", coverage
