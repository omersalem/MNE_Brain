# Codex AI Agent Profile

## 1. Purpose
Defines the platform execution profile for the Codex AI Agent.
...
## 4. Platform Notes
Available platform capabilities (e.g., CLI tools, script execution, automated linter) may be utilized to execute tasks, provided they never violate the read-only safety, zero-duplication, or governance rules defined in `[[AGENTS.md]]`.
