# OpenCode AI Agent Profile

## 1. Purpose
Defines the platform execution profile for the OpenCode AI Agent.
...
## 4. Platform Notes
Available platform capabilities (e.g., local LLM tools, offline terminal execution) may be utilized to execute tasks, provided they never violate the read-only safety, zero-duplication, or governance rules defined in `[[AGENTS.md]]`.
