...
## 1. Purpose
Defines the platform execution profile for the Pi AI Agent.
...
## 4. Platform Notes
Available platform capabilities (e.g., interactive chat tools, terminal inspection) may be utilized to execute tasks, provided they never violate the read-only safety, zero-duplication, or governance rules defined in `[[AGENTS.md]]`.
