...
export async function loadProviders(){
  ...
  document.querySelector('#codex-status').textContent=`Codex ${server.codex.status} · OpenCode ${server.opencode.status}`;
